...
$P(B)$ the probability of the specialist $B$ with respect to the
...
\begin{definition}
  ...
  \item The $(p,\Delta)$-interior set for $y=+1$ is
      ...
      \left\{x \in \all \left|
      \forall B \in \cB \mbox{ s.t. } (x \in B \mbox{ and } P(B) \leq
...
\section{Uniform convergence bounds for specialists}
