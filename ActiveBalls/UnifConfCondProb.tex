...
\[\bigl\lvert p(A\vert B) - p_n(A \vert B) \bigr\rvert \leq \frac{2\ln(1/\delta)}{\sqrt{k(B)}}.\]
...
\[\bigl(\forall B\in\B\bigr):\bigl\lvert p(A \vert B) - p_n(A \vert B) \bigr\rvert \leq O\Bigl(\frac{d\ln(1/\delta)}{\sqrt{k(B)}}\Bigr),\]
