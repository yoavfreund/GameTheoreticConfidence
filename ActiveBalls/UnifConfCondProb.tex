...
and therefore the random variable ``$k(B)\cdot p_n(A \vert B)$'' has distribution $Bin(k(B), p(A\vert B))$.
...
Another practical advantage of the uniform convergence bound in \Cref{thm:UCECM} is ``luckiness'':
