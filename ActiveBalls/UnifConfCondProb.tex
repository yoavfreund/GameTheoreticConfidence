...
than the which is significantly smaller than the rate of $\frac{d\ln n}{n}$, which is implied by \Cref{thm:UCECM}.

Another advantage is that  the uniform convergence bound in \Cref{thm:UCECM} is based on ``luckiness'':
